...
public class Regular4 {
    ...
    public static void main(String[] args) {
        ...
        int findCount = 0;
        int sameCount = 0;
        String text = "Найти в тексте все email-адреса и посчитать количество " +
                "адресов, имеющих одно и тоже account name  ( one@gmail.com  " +
                "one@gmail.com рщршгршгр one@mail.com )";
